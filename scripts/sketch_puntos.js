...
function drawScore() {
  if (textoActivado == 1) {
    ...
    if (nTeams >= 5) {
      text("puntos\n\n" + puntosTlacuache, xTlacuache - wTlacuache / 2, yTlacuache - hTlacuache * 1.0, wTlacuache, hTlacuache);      
    }
    if (nTeams > 5) {
      text("puntos\n\n" + puntosOcelote, xOcelote - wOcelote / 2, yOcelote - hOcelote * 1.0, wOcelote, hOcelote);
    }
    textAlign(LEFT);
  }
}
